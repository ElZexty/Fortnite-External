...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddQuadFilled(bbMin.Min, bbMin.Max, bbMax.Min, bbMax.Max, ImGui::GetColorU32(ImGuiCol_FrameBg));
    ...
    window->DrawList->AddQuadFilled(bbMin.Min, bbMin.Max, grabMax.Min, grabMax.Max, ImColor(35, 35, 35, 200));
    window->DrawList->AddQuad(bbMin.Min, bbMin.Max, bbMax.Min, bbMax.Max, ImColor(0, 0, 0, 1));
    window->DrawList->AddQuad(bbMin.Min, bbMin.Max, bbMax.Min, bbMax.Max, ImColor(45, 45, 45));
